...
- Windows GitHub Actions build validation and portable artifact packaging using MSYS2 UCRT64, CMake, Ninja, Qt 6 Widgets, FFmpeg 7.1.x core libraries, `libx264`, `libx265`, and a pinned source build of `libassmod`.
...
3. Audits configure-time dependency discovery, including FFmpeg 7.1.x series checks for the active core-library set.

...
- The current M17 slice now also includes fixing the first-round desktop integration regressions around SVG action icons, branding consistency, queue-table paint artifacts, native Windows caption behavior, and overly constrained desktop-shell sizing/density in the refreshed window.
